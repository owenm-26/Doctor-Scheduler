...
out = cv2.VideoWriter('pose_movement2.mp4', fourcc, fps, (frame_width, frame_height))
...
while cap.isOpened():
    ...
    # Write the original frame (without overlay) to the video file
    out.write(frame)
...
np.save('pose_movement.npy', pose_array)

print(f"Pose data saved to 'pose_movement.npy' with shape {pose_array.shape}")
print("Video saved to 'pose_movement.mp4'")